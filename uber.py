...
class Ride_Sharing:
    ...
    def __repr__(self) -> str:
        return f'{self.company_name}\nwith riders : {len(self.riders)} and drivers : {len(self.drivers)}'
...
class Rider(User):
    ...
    def display_profile(self):
        ...
        print(f'Rider email : {self.email}')
...
class Driver(User):
    ...
    def display_profile(self):
        ...
        print(f'Driver email : {self.email}')
...
class Ride_matching:
    ...
    def find_driver(self, ride_request):
        if len(self.available_drivers) > 0:
            # Initialized dynamically the first driver as selected driver
...
r = Ride_Sharing('Jabo')
sakib = Rider('Sakib khan','sakib@gmail.com', 6251, 'Noakhali', 1200)
r.add_rider(sakib)
kala = Driver('Kala mia', "kala@gmail.com", 1224, 'Noakhalir pashe')
r.add_driver(kala)
print(r)
sakib.request_ride(r, 'Uttara')
